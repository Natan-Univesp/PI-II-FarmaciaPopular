...
export function FormLoteMedicamento({
   dataLoteMedicamento,
   handleLoteMedicamentoSubmit,
   nomeMedicamento,
   isNewRegister = false,
}) {
   const {
   ...
   return (
      <form action="" className="layoutFormContentSpacing" onSubmit={handleSubmit(filterAndSubmit)}>
         ...
         <InputDefault
            ...
            register={{
               ...registerDataWithMask("data_validade", ["99-99-9999"], {
                  required: "Campo Obrigatório",
               }),
            }}
         ...
         >
            {dataLoteMedicamento ? "Confirmar Alterações" : "Cadastrar Lote"}
         </button>
      </form>
   );
}
