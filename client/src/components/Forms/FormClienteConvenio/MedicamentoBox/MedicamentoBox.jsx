...
export function MedicamentoBox({ fields, append, remove, medicamentoOptions = [], control, errors }) {
   /*
    =========================================================================
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Funções referentes ao Box (adiciona e remove Box de Medicamentos)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    =========================================================================
    */
   const addBoxList = () => {
      if (fields.length < 6) {
         append({ fk_id_medicamento: null });
      }
   };
